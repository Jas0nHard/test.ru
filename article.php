                      ...
                      while($comment = mysqli_fetch_assoc($comments) )
                      {
                        ...
                        <article class="article">
                          ...
                          <div class="article__info">
                            <a href="/article.php?id=<?php echo $comment['articles_id']; ?>"><?php echo $comment['author']; ?></a> <div class="article__info__meta"></div>
                ...
                <div class="block__content">
                  <form class="form" method="POST" action="/article.php?id=<?php echo $art['id']; ?>#comment-add-form">
                    ...
                    <div class="form__group">
                     ...
                     <div class ="col-md-4">
                       <textarea class="form__control" name="text" placeholder="Текст коментария ... "></textarea>
                     </div>
                     <div class ="form__group">
                        <input type="submit" name="do_post" value="Добавить коментарий" class="form__control">
                     </div>
                </form>
              </div>
             </div> 
